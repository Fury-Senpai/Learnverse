...
const PrivacyPolicy = () => {
    ...
    <div className='privacy-div'>
        <h1 className='text-black text-extra-bold'>Privacy Policy</h1>
        ...
        <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to Learnverse.</p>
        </li>
        <li>
        ...
        <li>
        <p><strong>Website</strong> refers to Learnverse, accessible from <a href="https://learnverse-pink.vercel.app/" rel="external nofollow noopener" target="_blank">https://learnverse-pink.vercel.app/</a>.</p>
        </li>
        <li>
        ...
        <ul>
        <li>By email: harbola03nitish@gmail.com</li>
        </ul>
    </div>
